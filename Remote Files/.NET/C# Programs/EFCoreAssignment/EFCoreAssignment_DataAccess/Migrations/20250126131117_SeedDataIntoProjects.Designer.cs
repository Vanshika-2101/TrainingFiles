...
namespace EFCoreAssignment_DataAccess.Migrations
{
    ...
    [Migration("20250126131117_SeedDataIntoProjects")]
    partial class SeedDataIntoProjects
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EFCoreAssignment_Models.Models.Employees", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Email = "aaron@ms",
                            FirstName = "Aaron",
                            HireDate = new DateTime(2025, 1, 26, 18, 41, 17, 759, DateTimeKind.Local).AddTicks(5965),
                            JobId = "SA_REP",
                            LastName = "Whitmore",
                            ManagerId = 2,
                        ...
                        new
                        {
                            ...
                            Email = "bonnie@ms",
                            FirstName = "Bonnie",
                            HireDate = new DateTime(2025, 1, 26, 18, 41, 17, 759, DateTimeKind.Local).AddTicks(5977),
                            JobId = "IT_REP",
                            LastName = "Bennett",
                            ManagerId = 3,
                        ...
                        new
                        {
                            ...
                            Email = "caroline@ms",
                            FirstName = "Caroline",
                            HireDate = new DateTime(2025, 1, 26, 18, 41, 17, 759, DateTimeKind.Local).AddTicks(5979),
                            JobId = "IT_PROG",
                            LastName = "Forbes",
                            ManagerId = 3,
                        ...
                        new
                        {
                            ...
                            Email = "damon@ms",
                            FirstName = "Damon",
                            HireDate = new DateTime(2025, 1, 26, 18, 41, 17, 759, DateTimeKind.Local).AddTicks(5980),
                            JobId = "MARK_REP",
                            LastName = "Salvatore",
                            ManagerId = 5,
                        ...
                        new
                        {
                            ...
                            Email = "elena@ms",
                            FirstName = "Elena",
                            HireDate = new DateTime(2025, 1, 26, 18, 41, 17, 759, DateTimeKind.Local).AddTicks(5982),
                            JobId = "CEO",
                            LastName = "Gilbert",
                            ManagerId = 5,
