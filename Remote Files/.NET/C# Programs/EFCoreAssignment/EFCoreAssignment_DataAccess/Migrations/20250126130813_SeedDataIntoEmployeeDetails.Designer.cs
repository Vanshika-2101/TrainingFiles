...
namespace EFCoreAssignment_DataAccess.Migrations
{
    ...
    [Migration("20250126130813_SeedDataIntoEmployeeDetails")]
    partial class SeedDataIntoEmployeeDetails
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EFCoreAssignment_Models.Models.Employees", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Email = "aaron@ms",
                            FirstName = "Aaron",
                            HireDate = new DateTime(2025, 1, 26, 18, 38, 13, 201, DateTimeKind.Local).AddTicks(9166),
                            JobId = "SA_REP",
                            LastName = "Whitmore",
                            ManagerId = 2,
                        ...
                        new
                        {
                            ...
                            Email = "bonnie@ms",
                            FirstName = "Bonnie",
                            HireDate = new DateTime(2025, 1, 26, 18, 38, 13, 201, DateTimeKind.Local).AddTicks(9175),
                            JobId = "IT_REP",
                            LastName = "Bennett",
                            ManagerId = 3,
                        ...
                        new
                        {
                            ...
                            Email = "caroline@ms",
                            FirstName = "Caroline",
                            HireDate = new DateTime(2025, 1, 26, 18, 38, 13, 201, DateTimeKind.Local).AddTicks(9177),
                            JobId = "IT_PROG",
                            LastName = "Forbes",
                            ManagerId = 3,
                        ...
                        new
                        {
                            ...
                            Email = "damon@ms",
                            FirstName = "Damon",
                            HireDate = new DateTime(2025, 1, 26, 18, 38, 13, 201, DateTimeKind.Local).AddTicks(9178),
                            JobId = "MARK_REP",
                            LastName = "Salvatore",
                            ManagerId = 5,
                        ...
                        new
                        {
                            ...
                            Email = "elena@ms",
                            FirstName = "Elena",
                            HireDate = new DateTime(2025, 1, 26, 18, 38, 13, 201, DateTimeKind.Local).AddTicks(9180),
                            JobId = "CEO",
                            LastName = "Gilbert",
                            ManagerId = 5,
