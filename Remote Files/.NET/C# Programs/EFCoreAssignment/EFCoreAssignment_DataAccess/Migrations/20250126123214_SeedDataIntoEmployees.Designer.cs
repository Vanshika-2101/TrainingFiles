...
namespace EFCoreAssignment_DataAccess.Migrations
{
    ...
    [Migration("20250126123214_SeedDataIntoEmployees")]
    partial class SeedDataIntoEmployees
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EFCoreAssignment_Models.Models.Employees", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Email = "aaron@ms",
                            FirstName = "Aaron",
                            HireDate = new DateTime(2025, 1, 26, 18, 2, 13, 846, DateTimeKind.Local).AddTicks(8462),
                            JobId = "SA_REP",
                            LastName = "Whitmore",
                            ManagerId = 2,
                        ...
                        new
                        {
                            ...
                            Email = "bonnie@ms",
                            FirstName = "Bonnie",
                            HireDate = new DateTime(2025, 1, 26, 18, 2, 13, 846, DateTimeKind.Local).AddTicks(8472),
                            JobId = "IT_REP",
                            LastName = "Bennett",
                            ManagerId = 3,
                        ...
                        new
                        {
                            ...
                            Email = "caroline@ms",
                            FirstName = "Caroline",
                            HireDate = new DateTime(2025, 1, 26, 18, 2, 13, 846, DateTimeKind.Local).AddTicks(8474),
                            JobId = "IT_PROG",
                            LastName = "Forbes",
                            ManagerId = 3,
                        ...
                        new
                        {
                            ...
                            Email = "damon@ms",
                            FirstName = "Damon",
                            HireDate = new DateTime(2025, 1, 26, 18, 2, 13, 846, DateTimeKind.Local).AddTicks(8476),
                            JobId = "MARK_REP",
                            LastName = "Salvatore",
                            ManagerId = 5,
                        ...
                        new
                        {
                            ...
                            Email = "elena@ms",
                            FirstName = "Elena",
                            HireDate = new DateTime(2025, 1, 26, 18, 2, 13, 846, DateTimeKind.Local).AddTicks(8477),
                            JobId = "CEO",
                            LastName = "Gilbert",
                            ManagerId = 5,
