...
namespace EFCoreAssignment_DataAccess.Migrations
{
    ...
    [Migration("20250126131640_SeedDataIntoEmployeeProject")]
    partial class SeedDataIntoEmployeeProject
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EFCoreAssignment_Models.Models.Employees", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Email = "aaron@ms",
                            FirstName = "Aaron",
                            HireDate = new DateTime(2025, 1, 26, 18, 46, 39, 781, DateTimeKind.Local).AddTicks(2280),
                            JobId = "SA_REP",
                            LastName = "Whitmore",
                            ManagerId = 2,
                        ...
                        new
                        {
                            ...
                            Email = "bonnie@ms",
                            FirstName = "Bonnie",
                            HireDate = new DateTime(2025, 1, 26, 18, 46, 39, 781, DateTimeKind.Local).AddTicks(2290),
                            JobId = "IT_REP",
                            LastName = "Bennett",
                            ManagerId = 3,
                        ...
                        new
                        {
                            ...
                            Email = "caroline@ms",
                            FirstName = "Caroline",
                            HireDate = new DateTime(2025, 1, 26, 18, 46, 39, 781, DateTimeKind.Local).AddTicks(2292),
                            JobId = "IT_PROG",
                            LastName = "Forbes",
                            ManagerId = 3,
                        ...
                        new
                        {
                            ...
                            Email = "damon@ms",
                            FirstName = "Damon",
                            HireDate = new DateTime(2025, 1, 26, 18, 46, 39, 781, DateTimeKind.Local).AddTicks(2294),
                            JobId = "MARK_REP",
                            LastName = "Salvatore",
                            ManagerId = 5,
                        ...
                        new
                        {
                            ...
                            Email = "elena@ms",
                            FirstName = "Elena",
                            HireDate = new DateTime(2025, 1, 26, 18, 46, 39, 781, DateTimeKind.Local).AddTicks(2295),
                            JobId = "CEO",
                            LastName = "Gilbert",
                            ManagerId = 5,
